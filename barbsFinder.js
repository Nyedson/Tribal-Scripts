...
var translations = {
    ...
    sk_SK: {
        ...
        'Radius:': 'VzdialenosÅ¥:',
        'Barbs found:': 'NájdenÃ© barbarky:',
        'Coordinates:': 'SÃºradnice:',
        'Error while fetching "village.txt"!': 'Chyba pri naÄítaní "village.txt"!',
        Coords: 'SÃºradnice',
        Points: 'Body',
        'Dist.': 'Vzdial.',
        Attack: 'Ãštok',
        Filter: 'Filter',
        Reset: 'Reset',
        'No barbarian villages found!': 'Neboli nájdenÃ© Å¾iadne dediny barbarov!',
        'Current Village:': 'SÃºÄasná dedina:',
        'Sequential Scout Script:': 'Sequential Scout Script:',
        Help: 'Pomoc',
    },
    fr_FR: {
